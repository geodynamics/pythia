...
class IPAService(TCPService):
    ...
    class Inventory(TCPService.Inventory):
        ...
        ticketOnce = pythia.pyre.inventory.bool("ticketOnce", default=True)
        ticketDuration = pythia.pyre.inventory.dimensional("ticketDuration", default=0.5*hour)

        marshaller = pythia.pyre.inventory.facility("marshaller", factory=pythia.pyre.ipa.pickler)
        userManager = pythia.pyre.inventory.facility("userManager", factory=pythia.pyre.ipa.userManager)
...
# version
__id__ = "$Id: IPAService.py,v 1.6 2005/04/23 00:35:56 pythia.pyre Exp $"
