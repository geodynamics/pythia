...
class Service(Component):
    ...
    class Inventory(Component.Inventory):
        ...
        timeout = pythia.pyre.inventory.dimensional("timeout", default=10.0 * minute)
    ...
    def onConnectionAttempt(self, selector, monitor):
        raise NotImplementedError("class %r must override 'onConnectionAttempt'" % self.__class__.__name__)
    ...
    def _createEvaluator(self):
        import pythia.pyre.services
        return pythia.pyre.services.evaluator()

    def _createSelector(self):
        import pythia.pyre.ipc
        return pythia.pyre.ipc.selector()

    def _createPortMonitor(self):
        raise NotImplementedError("class %r must override '_createPortMonitor'" % self.__class__.__name__)
...
# version
__id__ = "$Id: Service.py,v 1.2 2005/04/21 22:19:14 pythia.pyre Exp $"
