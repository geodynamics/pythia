...
class ClientServer(Script):
    ...
    class Inventory(Script.Inventory):
        ...
        client = pythia.pyre.inventory.bool("client", default=False)
        server = pythia.pyre.inventory.bool("server", default=False)

        # delay before client is spawned
        delay = pythia.pyre.inventory.float("delay", default=2.0)
