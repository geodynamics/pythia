...
class Component(Configurable):
    ...
    class Inventory(Configurable.Inventory):
        ...
        usage = pythia.pyre.inventory.bool("help", default=False)
        usage.meta['tip'] = 'prints a screen that describes my traits'

        showProperties = pythia.pyre.inventory.bool("help-properties", default=False)
        showProperties.meta['tip'] = 'prints a screen that describes my properties'

        showComponents = pythia.pyre.inventory.bool("help-components", default=False)
        showComponents.meta['tip'] = 'prints a screen that describes my subcomponents'

        showCurator = pythia.pyre.inventory.bool("help-persistence", default=False)
