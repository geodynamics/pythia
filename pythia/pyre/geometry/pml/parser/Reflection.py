...
class Reflection(Transformation):
    ...
    def notify(self, parent):
        ...
        reflection = pythia.pyre.geometry.operations.reflect(body=self._body, vector=self._vector)
...
# version
__id__ = "$Id: Reflection.py,v 1.1.1.1 2005/03/08 16:13:45 aivazis Exp $"
