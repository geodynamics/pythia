...
from pythia.pyre.geometry.Visitor import Visitor
from pythia.pyre.weaver.mills.XMLMill import XMLMill
...
# version
__id__ = "$Id: Renderer.py,v 1.1.1.1 2005/03/08 16:13:44 aivazis Exp $"
