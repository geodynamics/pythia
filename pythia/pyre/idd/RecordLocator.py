...
class RecordLocator(Component):
    ...
    class Inventory(Component.Inventory):
        ...
        alphabet = pythia.pyre.inventory.str('alphabet', default="23456789ABCDEFGHIJKLMNPQRSTUVWXYZ")
...
# version
__id__ = "$Id: RecordLocator.py,v 1.3 2005/04/28 03:37:16 pythia.pyre Exp $"
