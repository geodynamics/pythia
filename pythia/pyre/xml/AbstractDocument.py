...
class AbstractDocument(object):
    ...
    def node(self, tag, attributes):
        raise NotImplementedError("class '%s' should override method 'node'" % self.__class__.__name__)
    ...
    def _getLocator(self):
        ...
        return pythia.pyre.parsing.locators.file(filename, line, column)
...
# version
__id__ = "$Id: AbstractDocument.py,v 1.1.1.1 2005/03/08 16:13:41 aivazis Exp $"
