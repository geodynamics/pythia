...
class Inventory(object, metaclass=Notary):
    ...
    def loadConfiguration(self, filestem):
        ...
        codec = pythia.pyre.inventory.codecPML()
    ...
    def retrieveComponent(
        ...
        if extraDepositories:
            ...
            pythia.journal.diagnostics.firewall("inventory").log("non-null extraDepositories")
        ...
        for name in keys:
            ...
            try:
                ...
                if context:
                    ...
                    locator = pythia.pyre.parsing.locators.stackTrace(stackTrace)
