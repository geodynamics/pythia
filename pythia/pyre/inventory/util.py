...
from pythia.pyre.inventory.odb.Inventory import Inventory as OdbInventory
from pythia.pyre.inventory.odb.Registry import Registry as OdbRegistry
...
if __name__ == "__main__":
    ...
    from pythia.pyre.applications import Script
    ...
    class UtilTest(Script):
        ...
        answer = pythia.pyre.inventory.int("answer", default=42)
