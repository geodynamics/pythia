...
class SimulationController(Component):
    ...
    class Inventory(Component.Inventory):
        ...
        restart = pythia.pyre.inventory.bool("restart", default=False)
        restartStep = pythia.pyre.inventory.int("restartStep", default=0)
        dt = pythia.pyre.inventory.float("dt", default=1.0)
        frameFrequency = pythia.pyre.inventory.int("frameFrequency", default=100)
        checkpointFrequency = pythia.pyre.inventory.int("checkpointFrequency", default=100)
        monitoringFrequency = pythia.pyre.inventory.int("monitoringFrequency", default=100)
        outputDirectory = pythia.pyre.inventory.str("outputDirectory", default=".")
